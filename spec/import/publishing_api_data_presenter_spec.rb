...
module Import
  RSpec.describe PublishingApiDataPresenter do
    ...
    it "presents row data from publishing-api in a form suitable for insertion in the local sqlite db" do
      ...
      rows = PublishingApiDataPresenter.present(content_id_data)
